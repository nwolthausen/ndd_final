...
#Logistic regression for diarrhea and wealth
diarrhealogit<- glm(ndd_ada.diarrhea_any_type_b ~ WI_quintile, data = complete_ndd,
                    family = "binomial")
summary(diarrhealogit)

#ORs and 95% CIs
ORwi<-exp(cbind(OR = coef(diarrhealogit), confint(diarrhealogit))) 
ORbmi 
